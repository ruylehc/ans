...
# Hybrid inventory example
'''
we hard coded some json within example_inventory(). In production, we would want our script to make an API call, or parse some file.
To access the hard-coded JSON inventory within our script, just run the script with the --list parameter.
'''
